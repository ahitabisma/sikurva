...
<div x-data="{
    ...
    x-on:open-download-modal.window="open($event.detail.points, $event.detail.callback, $event.detail.message)"
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 max-w-md mx-auto"
            ...
            <div class="flex flex-col">
                ...
                <div class="mb-4" @click.stop>
                    <label for="skipDownloadConfirmation" class="flex cursor-pointer items-center text-sm select-none"
                        @click.stop>
                        <div class="relative" @click.stop>
                            <input type="checkbox" name="skipConfirmation" id="skipDownloadConfirmation" class="sr-only"
