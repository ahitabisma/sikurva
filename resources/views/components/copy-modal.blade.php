...
<div x-data="{
    ...
    x-on:open-copy-modal.window="open($event.detail.points, $event.detail.callback, $event.detail.message)"
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 max-w-md mx-auto"
            ...
            <div class="flex flex-col">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-semibold text-gray-800">Copy</h3>
                ...
                <div class="mb-4" @click.stop>
                    <label for="skipCopyConfirmation" class="flex cursor-pointer items-center text-sm select-none"
                        @click.stop>
                        <div class="relative" @click.stop>
                            <input type="checkbox" name="skipConfirmation" id="skipCopyConfirmation"
