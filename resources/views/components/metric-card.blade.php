@props(['title', 'value', 'icon', 'change', 'isIncrease'])
...
<div class="rounded-2xl border border-gray-200 bg-white p-5 md:p-6">
    ...
    <div class="mt-5 flex items-end justify-between">
        ...
        <span
            class="flex items-center gap-1 rounded-full py-0.5 pl-2 pr-2.5 text-sm font-medium {{ $isIncrease ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600' }}">
