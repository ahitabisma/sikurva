        ...
        <div>
            <div class="mx-auto w-full max-w-[460px] text-center">
                <div class="flex flex-wrap justify-center mb-6">
                    <div class="p-6 rounded-full bg-amber-50">
                        <i class="fas fa-exclamation-triangle text-amber-500 text-5xl"></i>
                    </div>
                </div>

                <h1 class="flex flex-wrap justify-center text-xl font-bold text-amber-500 xl:text-4xl mb-2">
                    500
                </h1>
                ...
                <p class="text-base text-gray-500 mb-6">
                    {{ $exception->getMessage() ?: 'Sorry, something went wrong on our servers.' }}
                </p>
