        ...
        <div>
            <div class="mx-auto w-full max-w-[460px] text-center">
                <div class="flex flex-wrap justify-center mb-6">
                    <div class="p-6 rounded-full bg-purple-50">
                        <i class="fas fa-clock text-purple-500 text-5xl"></i>
                    </div>
                </div>

                <h1 class="flex flex-wrap justify-center text-xl font-bold text-purple-500 xl:text-4xl mb-2">
                    419
                </h1>
                ...
                <p class="text-base text-gray-500 mb-6">
                    {{ $exception->getMessage() ?: 'Sorry, your session has expired. Please go back, refresh the page and try again.' }}
                </p>
