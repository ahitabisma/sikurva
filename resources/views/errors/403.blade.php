        ...
        <div>
            <div class="mx-auto w-full max-w-[460px] text-center">
                <div class="flex flex-wrap justify-center mb-6">
                    <div class="p-6 rounded-full bg-red-50">
                        <i class="fas fa-lock text-red-500 text-5xl"></i>
                    </div>
                </div>

                <h1 class="flex flex-wrap justify-center text-xl font-bold text-red-500 xl:text-4xl mb-2">
                    403
                </h1>
                ...
                <p class="text-base text-gray-500 mb-6">
                    {{ $exception->getMessage() ?: 'Sorry, you do not have permission to access this page.' }}
                </p>
