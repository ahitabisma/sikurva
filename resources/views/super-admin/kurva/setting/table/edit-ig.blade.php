...
@section('content')
    <div class="rounded-2xl border border-gray-200 bg-white">
        <div class="p-5 space-y-6 border-t border-gray-100 sm:p-6">
            <form action="{{ route('super-admin.kurva.setting.table.update-ig', [$namaTabel, $data->id]) }}" method="POST">
                @csrf
                @method('PUT')
