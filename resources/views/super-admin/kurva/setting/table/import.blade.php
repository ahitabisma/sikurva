    ...
    <div class="rounded-2xl border border-gray-200 bg-white mb-6">
        <div class="p-5 space-y-6 border-t border-gray-100 sm:p-6">
            <div class="flex justify-between items-center">
                <div>
                    <a href="{{ route('super-admin.kurva.setting.table.export', $namaTabel) }}"
                        ...
                        Download Template {{ ucfirst($namaTabel) }}
                    </a>
                </div>
            </div>

            <form action="{{ route('super-admin.kurva.setting.table.import-store', $namaTabel) }}" method="POST"
