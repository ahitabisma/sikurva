    ...
    <div class="rounded-2xl border border-gray-200 bg-white mb-6">
        <div class="p-5 space-y-6 border-t border-gray-100 sm:p-6">
            <div class="flex justify-between items-center">
                <div>
                    <a href="{{ route('super-admin.patient.export-template') }}"
            ...
            <form action="{{ route('super-admin.patient.import-store') }}" method="POST" enctype="multipart/form-data"
                id="import-patient-form">
                @csrf
