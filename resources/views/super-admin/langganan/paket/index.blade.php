        ...
        <div class="border-t border-gray-100 p-5 sm:p-6">
            ...
            <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white pt-4">
                <div class="flex flex-col gap-5 px-6 mb-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <x-tambah-button url="{{ route('super-admin.langganan.paket.create') }}" text="Tambah Paket" />
                    </div>

                    <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                        <form method="GET" action="{{ route('super-admin.langganan.paket.index') }}"
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-3 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <p
                                                class="rounded-full px-2 py-0.5 text-theme-xs font-medium {{ $paket->status ? 'bg-success-50 text-success-600' : 'bg-error-50 text-error-600' }}">
                                                {{ $paket->status ? 'Aktif' : 'Tidak Aktif' }}
                                            </p>
                                        </div>
                                    </td>
                                    <td class="px-6 py-3 whitespace-nowrap">
                                        <div class="flex items-center justify-center space-x-2">
                                            <a href="{{ route('super-admin.langganan.paket.edit', $paket->id) }}"
                                                type="button"><x-svg-edit /></a>
                                            <x-modal-delete title="Hapus Paket"
                                                message="Apakah Anda yakin ingin menghapus data paket ini?"
                                                confirmText="Hapus" cancelText="Batal"
                                                url="{{ route('super-admin.langganan.paket.destroy', $paket->id) }}" />
                                        </div>
                                    </td>
                                </tr>
                            @empty
