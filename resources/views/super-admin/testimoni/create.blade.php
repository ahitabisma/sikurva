...
@section('content')
    <div class="rounded-2xl border border-gray-200 bg-white">
        <div class="p-5 space-y-6 border-t border-gray-100 sm:p-6">
            <form action="{{ route('super-admin.testimoni.store') }}" method="POST" x-data="userSelect()">
                @csrf
                <div class="-mx-2.5 flex flex-wrap gap-y-5">
                    <div class="w-full px-2.5 xl:w-full">
                        ...
                        <div class="relative z-20 bg-transparent">
                            <input type="text"
                                class="w-full px-4 py-3 text-sm text-gray-700 bg-white border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-brand-300 focus:outline-none"
                                placeholder="Cari user..." x-model="query" @input.debounce.300ms="searchUsers" />
                    ...
                    <!-- Rating Bintang -->
                    <div class="w-full px-2.5 xl:w-full" x-data="ratingSystem()">
                    ...
                    <div class="w-full px-2.5 xl:w-full">
                        ...
                        <x-textarea placeholder="Masukkan Testimoni" name="testimoni" required></x-textarea>
