...
@section('script')
    ...
    <script>
        function antroPointSelection() {
            return {
                ...
                debugPDF: async function(skipConfirmation = false) {
                    try {
                        loadingOverlay.classList.remove('hidden');
                        ...
                        const response = await fetch(`debug-pdf/${patientId}`, {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute(
                        ...
                        // showNotification('PDF berhasil dibuat dan ditampilkan!', false);
                    } catch (error) {
                ...
                generatePDF: async function(skipConfirmation = false) {
                    try {
                        loadingOverlay.classList.remove('hidden');
                ...
                generateAndSendPDF: async function(displayName, skipConfirmation = false) {
                    try {
                        loadingOverlay.classList.remove('hidden');
                ...
                generateAndSendCustomPDF: async function(emailAddress, displayName) {
                    try {
                        loadingOverlay.classList.remove('hidden');
                        ...
                        const response = await fetch(`/generate-and-send-custom-pdf/${patientId}`, {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute(
                ...
                generateAndSendWa: async function(waNumber) {
                    try {
                        loadingOverlay.classList.remove('hidden');
                        ...
                        const response = await fetch(`/generate-and-send-wa/${patientId}`, {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute(
    ...
    <script>
        ...
        // console.log(dataTable9);
        // console.log(arrayTable9);
