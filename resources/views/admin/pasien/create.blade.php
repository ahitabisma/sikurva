...
@section('content')
    <div class="rounded-2xl border border-gray-200 bg-white">
        <div class="p-5 space-y-6 border-t border-gray-100 sm:p-6">
            <form action="{{ route('patient.store') }}" method="POST" id="tambah-pasien-form" x-data="{
                ...
                <div class="-mx-2.5 flex flex-wrap gap-y-5">
                    <div class="w-full px-2.5">
                        <h4 class="pb-4 text-base font-medium text-gray-800 border-b border-gray-200">
                            Tambah Daftar {{ Auth::user()->is_nakes ? 'Pasien' : 'Anak' }}
                        </h4>
                    </div>
                    ...
                    <div class="w-full px-2.5">
                        <div class="flex items-center gap-3 mt-6">
                            <x-primary-button type="button"
                                @click="openConfirmationModal('Tambah {{ Auth::user()->is_nakes ? 'Pasien' : 'Anak' }}', tambahPasienPoint, (skipConfirmation) => {
                                        ...
                                        if (skipConfirmation) {
                                            ...
                                            skipInput.value = '1';
                                            document.getElementById('tambah-pasien-form').appendChild(skipInput);
                                        }
                                        // Then submit the form
                                        document.getElementById('tambah-pasien-form').submit();
