{{-- filepath: d:\laragon\www\closing\tumbuh-kembang\resources\views\admin\langganan\show.blade.php --}}
            ...
            <div class="md:col-span-2 rounded-2xl border border-gray-200 bg-white overflow-hidden">
                <div class="p-6 space-y-6">
                    <div class="w-full xl:w-full">
                        ...
                        <div class="relative z-1 bg-transparent">
                            <div
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    @if (isset($paymentDetails->bank))
                                        <div class="flex flex-col">
                                            ...
                                            <span class="text-sm font-medium">{{ strtoupper($paymentDetails->bank) }}</span>
                                        </div>
                                    @endif
                    ...
                    @if ($langganan->status === 'pending' && $langganan->snap_token)
                        <div class="mt-6">
                            <button type="button" @click="openPayment('{{ $langganan->snap_token }}')"
                                class="w-full px-4 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors flex justify-center items-center">
