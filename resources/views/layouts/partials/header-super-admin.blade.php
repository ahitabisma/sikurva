<header x-data="{ menuToggle: false }" class="sticky top-0 z-99999 flex w-full border-gray-200 bg-white lg:border-b shadow">
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            ...
            {{-- <a href="{{ Auth::user()->roles()->first()->name == 'admin' ? route('patient.index', absolute: false) : route('super-admin.dashboard', absolute: false) }}"
                class="lg:hidden">
                <img src="{{ asset('img/logo-ekurva.png') }}" alt="Logo" class="w-10" />
            </a> --}}
                ...
                <form>
                    <div class="relative">
                        ...
                        <input type="text" placeholder="Search or type command..." id="search-input"
                            class="shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 pr-14 pl-12 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden xl:w-[430px]" />
        ...
        <div :class="menuToggle ? 'flex' : 'hidden'"
            ...
            <div class="2xsm:gap-3 flex items-center gap-2">
                <div>
                    @role('admin')
                        <a href="#"
                            class="flex items-center justify-center gap-1 rounded-full bg-brand-500 px-2.5 py-0.5 font-medium text-theme-sm text-white transition duration-300 ease-in-out hover:bg-blue-800">
                            {{ Auth::user()->instansi ? Auth::user()->instansi->points : Auth::user()->points }} points
                        </a>
                    @endrole
                </div>
            </div>
