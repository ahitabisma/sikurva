...
use App\Exports\AntroExport;
use App\Exports\AntroExportAll;
...
class AntroController extends Controller
{
    ...
    public function create($patientId)
    {
        ...
        return view("super-admin.pasien.antro.create")->with([
            'title' => 'Tambah Antro',
            'patient' => $patient
        ]);
    }
    ...
    public function store(Request $request, $patientId)
    {
        ...
        return redirect()
            ->route('super-admin.patient.preview', ['id' => $patient->id])
            ->with('success', 'Data antropometri pasien berhasil ditambahkan.');
    }
    ...
    public function edit($id)
    {
        ...
        return view("super-admin.pasien.antro.edit")->with([
            'title' => 'Edit Antro',
            'patient' => $patient,
            'antro' => $antro
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()
            ->route('super-admin.patient.preview', ['id' => $patient->id])
            ->with('success', 'Data antropometri pasien berhasil diperbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        if (!$isDeleted) {
            return back()->with('error', 'Data antropometri pasien gagal dihapus.');
        }
        return back()->with('success', 'Data antropometri pasien berhasil dihapus.');
    }
    ...
    {
        $patient = $this->patientService->findById($patientId);
        return view('super-admin.pasien.antro.import')->with([
            'title' => 'Import Data Antro Pasien ' . $patient->nama,
            'patient' => $patient
        ]);
    }
    ...
    public function importStore(Request $request, $patientId)
    {
        ...
        try {
            ...
            return redirect()->route('super-admin.patient.preview', ['id' => $patientId])
                ->with('success', 'Data antro pasien berhasil diimport dari Excel');
    ...
    {
        $patient = $this->patientService->findById($patientId);
        return Excel::download(new AntroExport($patientId), 'Data Antro Pasien ' . $patient->nama . '.xlsx');
    }

    public function exportAll()
    {
        return Excel::download(new AntroExportAll(), 'Data Antro ' . config('app.name') . '.xlsx');
    }
}
